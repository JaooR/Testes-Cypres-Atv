describe("Filtrando tarefas em aberto", () =>{
    ...
    it("O sistema deve filtrar todas as tarefas em aberto no sistema e exibi-las na tabela de tarefas  ", () =>{
        
       
        cy.get('.d-flex > .btn').select('incomplete');
        cy.get('.pt-3 > .col-auto > .btn').should("have.value", "incomplete") 
